// src/pages/PlaytestComponents/LibraryViewer.tsx (ZMODYFIKOWANY)
...
export default function LibraryViewer({ player, toggleLibraryViewer, playerColorClass, isOwned }: LibraryViewerProps) {
