...
export default function Playtest() {
  ...
  const playerForBottombar = localPlayer ? localPlayer : viewedPlayer;
  // ===================================
  ...
  if (!session || (!localPlayer && !isSpectator)) {
    ...
    <div className="fixed-sessions-list" style={{ marginTop: "1rem", width: '100%', maxWidth: '500px' }}>
...
{/* ✅ ZMIANA 1: Zmieniamy warunek renderowania */}
  {playerForBottombar && ( 
    <Bottombar
      // ✅ ZMIANA 2: Przekazujemy 'playerForBottombar' jako główny 'player'
      player={playerForBottombar} 
      
      // Reszta propsów zostaje bez zmian:
      session={session}
      getPlayerColorClass={getPlayerColorClass}
      setDragOffset={setDragOffset}
      moveCard={moveCard}
      ...
      // Przekazujemy 'viewedPlayer' bez zmian, na wypadek gdyby 
      // komponent Bottombar używał go do innych celów (np. kontekstu)
